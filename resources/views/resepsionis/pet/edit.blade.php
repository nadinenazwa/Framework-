...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb bg-light rounded px-3 py-2">
            ...
            <li class="breadcrumb-item"><a href="{{ route('resepsionis.pet.show', $pet->idpet) }}">{{ $pet->nama_hewan }}</a></li>
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <h2 class="mb-1">
                <i class="bi bi-pencil-square"></i> Edit Hewan Peliharaan
            </h2>
            <p class="text-muted">Perbarui informasi hewan peliharaan</p>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">
                <i class="bi bi-clipboard-check"></i> Form Edit Hewan Peliharaan
            </h5>
        </div>
        <div class="card-body">
            <form action="{{ route('resepsionis.pet.update', $pet->idpet) }}" method="POST" id="petForm">
                @csrf
                @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <select name="idpemilik" id="idpemilik" class="form-select @error('idpemilik') is-invalid @enderror" required>
                            ...
                            @foreach($pemilik as $p)
                                <option value="{{ $p->idpemilik }}" @selected(old('idpemilik', $pet->idpemilik) == $p->idpemilik)>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nama_hewan" id="nama_hewan" 
                                   ...
                                   placeholder="Contoh: Fluffy, Max, Bella..." value="{{ old('nama_hewan', $pet->nama_hewan) }}" required>
                            @error('nama_hewan')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="warna" id="warna" 
                                   ...
                                   placeholder="Contoh: Putih, Hitam, Coklat..." value="{{ old('warna', $pet->warna) }}">
                            @error('warna')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="idjenis_hewan" id="idjenis_hewan" class="form-select @error('idjenis_hewan') is-invalid @enderror" required>
                                ...
                                @foreach($jenisHewan as $jenis)
                                    <option value="{{ $jenis->idjenis_hewan }}" @selected(old('idjenis_hewan', $pet->idjenis_hewan) == $jenis->idjenis_hewan)>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="idras_hewan" id="idras_hewan" class="form-select @error('idras_hewan') is-invalid @enderror" required>
                                ...
                                @foreach($rasHewan as $ras)
                                    <option value="{{ $ras->idras_hewan }}" @selected(old('idras_hewan', $pet->idras_hewan) == $ras->idras_hewan)>
                                        {{ $ras->nama_ras }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="umur" id="umur" step="0.1" min="0"
                                   ...
                                   placeholder="Contoh: 2, 3.5, 5..." value="{{ old('umur', $pet->umur) }}">
                            @error('umur')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="berat_badan" id="berat_badan" step="0.1" min="0"
                                   ...
                                   placeholder="Contoh: 5, 15.5, 20..." value="{{ old('berat_badan', $pet->berat_badan) }}">
                            @error('berat_badan')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                    <a href="{{ route('resepsionis.pet.show', $pet->idpet) }}" class="btn btn-secondary btn-lg">
