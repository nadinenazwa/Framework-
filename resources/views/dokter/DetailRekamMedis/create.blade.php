...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-md-8">
            <h2 class="mb-1">Tambah Detail Rekam Medis</h2>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            @if(session('success'))
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    {{ session('success') }}
                    <a href="{{ $rekamMedis->pet ? route('dokter.rekam_medis.index', $rekamMedis->pet->idpet) : route('dokter.dashboard') }}" class="btn btn-link btn-sm">Kembali ke Detail Rekam Medis</a>
            ...
            @endif
            <form action="{{ route('dokter.detail_rekam_medis.store', $rekamMedis->idrekam_medis) }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <a href="{{ $rekamMedis->pet ? route('dokter.rekam_medis.index', $rekamMedis->pet->idpet) : route('dokter.dashboard') }}" class="btn btn-secondary">Batal</a>
            </form>
        </div>
    </div>
</div>
