...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('pemilik.dashboard') }}" class="btn btn-secondary">Kembali ke Dashboard</a>
    </div>
    ...
    @forelse($riwayat as $rekam)
        <div class="card mb-3">
            <div class="card-header d-flex justify-content-between">
                    <strong>Kunjungan: {{ optional(optional($rekam->temuDokter)->waktu_daftar)->format('d M Y') ?: 'N/A' }}</strong>
