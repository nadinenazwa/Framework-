...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Data Jenis Hewan</h3>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('admin.jenish.create') }}" class="btn btn-primary btn-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('admin.jenish.edit', $item->idjenis_hewan) }}" class="btn btn-warning btn-sm">
